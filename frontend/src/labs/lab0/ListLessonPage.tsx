      ...
      <ThemeProvider>
        ...
        <div id="flex">
          <div>
            <h2 className="text-2xl">Formatting a stimulus</h2>
            <p className="text-left">
              Say we have 3 conditions that we want to check. Maybe we want to
              see if 1 condition has an effect rather than the other conditions
            </p>
            <p className="text-left">
              To do that, we'd have to make general stimuli number 1 and then
              create 3 variations to fit the 3 conditions
            </p>
            <p className="text-left">
          ...
          <div>
            <h2 className="text-2xl">Formatting a stimulus</h2>
            <p className="text-left">
              As can be seen above, we format our stimuli above like the
              following
            </p>
            <p className="text-left">
        ...
        <div id="flex">
          <div>
            ...
            <p className="text-left">
              Above, we discussed how to create a formatted stimulus. We could
              juse use the 3 stimuli from the above randomly; however, the
              participant will catch on quick on the content of the stimulus
            </p>
            <p className="text-left">
            ...
            <p className="text-left">
              ...
              counterbalancing list of different stimuli. In Neuroscience, we
              use 1a,2b,3c
            </p>
            <p className="text-left">
              That's dandy and all, but now we have 1b and 1c left. We can
              create another counterbalancing list with 1b,2c, and 3a
            </p>
            <p className="text-left">
          ...
          <div>
            ...
            <p className="text-left">
              More often than not, we want to test for a variation's effects
              more than once. In Neuroscience, we test with a variation for as
              many variations as there are
            </p>
            <p className="text-left">
              What this means is that if I had 4 variations, then I would want
              to test 1 variation 4 times. I also need to make a
              counterbalancing by adding in 3 elements times 4 since we don't
              want two variations to have the same condition.
            </p>
            <p className="text-left">
              In total, we would have a list of size 16 since 4 variations times
              4 tests = 16
            </p>
          </div>
        </div>
